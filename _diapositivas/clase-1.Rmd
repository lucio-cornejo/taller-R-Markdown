...
- Para crear **reportes reproducibles**.
...
en este [link](https://github.com/lucio-cornejo/r-markdown-summer-workshop/blob/main/_material/clase-1/ejemplo.Rmd).
...
&nbsp; `toc: true`&nbsp; y &nbsp; `toc_float: true`, ambos con un espaciado de **4 espacios vacíos**
...
output:
  html_document:
    ...
    highlight: github # un modelo predeterminado de cómo resaltar el código de la página web
---
```