...
<table id = "sesiones">
    <tr>
        ...
        <td><pre>4. Distill, Blogdown y Bookdown</pre></td>
        <td><pre>7. HTML y CSS</pre></td>
    </tr>
    <tr>
        <td><pre>2. Reportes parametrizados</pre></td>
        <td><pre>5. Dashboards y htmlwidgets</pre></td>
        <td><pre>8. Javascript</pre></td>
    </tr>
    <tr>
        <td><pre>3. Xaringan y creación de un sitio web</pre></td>
        <td><pre>6. Shiny</pre></td>
        <td><pre>9. R Markdown Intermedio</pre></td>
    </tr>
</table>
<!--#endregion-->
