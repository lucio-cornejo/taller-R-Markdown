...
<table id = "sesiones">
    <tr>
        <td><pre>Markdown y YAML</pre></td>
        <td><pre>Blogdown, parte 2</pre></td>
        <td><pre>JavaScript</pre></td>
    </tr>
    <tr>
        <td><pre>Reportes parametrizados</pre></td>
        <td><pre>Dashboards y htmlwidgets</pre></td>
        <td><pre>Shiny</pre></td>
    </tr>
    <tr>
        <td><pre>Bookdown y Blogdown</pre></td>
        <td><pre>HTML y CSS</pre></td>
        <td><pre>Xaringan</pre></td>
    </tr>
</table>
<!--#endregion-->
